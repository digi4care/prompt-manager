...
- Locate context directories (`/home/digi4care/.config/opencode/context/`, `docs/`, `.context/`, etc.)
...
```
/home/digi4care/.config/opencode/context/
...
```bash
list(path="/home/digi4care/.config/opencode/context")
```
...
list(path="/home/digi4care/.config/opencode/context/{category}")

# Read relevant files
read(filePath="/home/digi4care/.config/opencode/context/{category}/{file}.md")
```
...
**Context Location**: `/home/digi4care/.config/opencode/context/`
**Files Searched**: 12
...
#### ⭐⭐⭐⭐⭐ Code Standards
**Path**: `/home/digi4care/.config/opencode/context/core/standards/code.md`
...
/home/digi4care/.config/opencode/context/core/workflows/
└── review.md ⭐ FOUND
```
...
3. `/home/digi4care/.config/opencode/context/core/workflows/review.md` - Code review expectations
...
### Additional Context Available
If you need more information on:
- **Code standards** → Check `/home/digi4care/.config/opencode/context/core/standards/code.md`
- **Testing guidelines** → Check `/home/digi4care/.config/opencode/context/core/standards/tests.md`
```

## Discovery Patterns

### Pattern 1: Well-Organized Context
Repository has clear context structure (`/home/digi4care/.config/opencode/context/` or `docs/`)
