...
// Model profiles for OpenCode/Gemini environment
// quality = openai/gpt-5.3-codex (best reasoning)
// balanced = zai-coding-plan/glm-5 (good balance)
// budget = minimax-coding-plan/MINIMAX-M2.5 (cost-effective)
const MODEL_PROFILES = {
	'gsd-planner': {
		quality: 'openai/gpt-5.3-codex',
		balanced: 'openai/gpt-5.3-codex',
		budget: 'zai-coding-plan/glm-5'
	},
	'gsd-roadmapper': {
		quality: 'openai/gpt-5.3-codex',
		balanced: 'zai-coding-plan/glm-5',
		budget: 'zai-coding-plan/glm-5'
	},
	'gsd-executor': {
		quality: 'openai/gpt-5.3-codex',
	...
	'gsd-phase-researcher': {
		quality: 'openai/gpt-5.3-codex',
		balanced: 'zai-coding-plan/glm-5',
		budget: 'minimax-coding-plan/MINIMAX-M2.5'
	},
...
function resolveModelInternal(cwd, agentType) {
	...
	const profile = config.model_profile || 'balanced';
	const agentModels = MODEL_PROFILES[agentType];
	// Default to balanced model (zai-coding-plan/glm-5)
	if (!agentModels) return 'zai-coding-plan/glm-5';
	return agentModels[profile] || agentModels['balanced'] || 'zai-coding-plan/glm-5';
}
