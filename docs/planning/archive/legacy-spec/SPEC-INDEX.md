...
| `SPEC-14-ai-settings-contract-v1.md`          | Variant-aware AI settings API contract | `AIC-*`           |
| `SPEC-15-docs-testing-execution-blueprint.md` | Test-workflow generation orchestration | `XBP-*`           |
...
- Variant-aware AI settings request/response contract: `SPEC-14-ai-settings-contract-v1.md` (`AIC-005`, `AIC-006`, `AIC-007`, `AIC-010`).
- docs/testing generation and execution gates: `SPEC-15-docs-testing-execution-blueprint.md` (`XBP-007`, `XBP-010`, `XBP-016`).
...
4. Load workflow orchestration blueprint: `SPEC-15`.
5. Enforce acceptance and test mapping: `SPEC-07` + `SPEC-08`.
